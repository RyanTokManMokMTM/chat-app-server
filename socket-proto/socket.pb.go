...
type Message struct {
	...
	Type         string `protobuf:"bytes,7,opt,name=type,proto3" json:"type,omitempty"`                 //For example: "heatbeat" for checking server/client health , video call/audio call ->"webrtc"
	MessageType  int32  `protobuf:"varint,8,opt,name=messageType,proto3" json:"messageType,omitempty"`  //1: p2p 2: group
}
