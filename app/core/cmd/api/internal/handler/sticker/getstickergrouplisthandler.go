...
func GetStickerGroupListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetStickerListReq
		...
		l := sticker.NewGetStickerGroupListLogic(r.Context(), svcCtx)
		resp, err := l.GetStickerGroupList(&req)
		if err != nil {
