...
import (
	...
	"github.com/ryantokmanmokmtm/chat-app-server/app/core/cmd/api/internal/logic/sticker"
...
func GetStickerGroupResourcesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetStickerResourcesReq
		...
		l := sticker.NewGetStickerGroupResourcesLogic(r.Context(), svcCtx)
		resp, err := l.GetStickerGroupResources(&req)
		if err != nil {
