...
func DeleteUserStickerHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteStickerReq
		...
		l := user.NewDeleteUserStickerLogic(r.Context(), svcCtx)
		resp, err := l.DeleteUserSticker(&req)
		if err != nil {
