...
import (
	...
	"github.com/ryantokmanmokmtm/chat-app-server/app/core/cmd/api/internal/logic/user"
...
func GetUserFriendProfileHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetUserFriendProfileReq
		...
		l := user.NewGetUserFriendProfileLogic(r.Context(), svcCtx)
		resp, err := l.GetUserFriendProfile(&req)
		if err != nil {
